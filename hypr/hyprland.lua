...
hl.config({
    general = {
        ...
        col = {
            active_border   = "rgba(669bbcee)",
            inactive_border = "rgba(495057aa)",
        },
...
hl.bind(mainMod .. " + CTRL + left",  hl.dsp.window.resize({ x=-150, y=0, relative=true }))
hl.bind(mainMod .. " + CTRL + right",  hl.dsp.window.resize({ x=150, y=0, relative=true }))

hl.bind(mainMod .. " + CTRL + up",  hl.dsp.window.resize({ y=-50, x=0, relative=true }))
hl.bind(mainMod .. " + CTRL + down",  hl.dsp.window.resize({ y=50, x=0, relative=true }))
